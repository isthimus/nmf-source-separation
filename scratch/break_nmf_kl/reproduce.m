...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
run('../../source/scripts/setpaths.m') % CHANGED PATHNAMES HERE
...
theRandState = load('./randstate_159.mat');
rng(theRandState.randState)
