function [testvectors, testdefs] = gen_tables(switches);
    ...
    if TESTDEFS_MAIN
        ...
        testdefs{end+1} = struct (...
            "name"     , "MStandardTaxi", ...
            "testFunc" , @align_onsUtil_specDiff_taxi, ...
            "spectInfo", si_std ...
        );
        ...
        testdefs{end+1} = struct (...
            ...
            "testFunc" , @align_onsUtil_specDiff_rectL2, ...
            "spectInfo", si_std ...
        );
        ...
        testdefs{end+1} = struct (...
            "name"     , "MtaxiPesky0", ...
            "testFunc" , @align_onsUtil_specDiff_taxi_pesky0, ...
            "spectInfo", si_std ...
        );

        % taxi, with block normalisation, width 100, no dropout thresh
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),100,-99);
        testdefs{end+1} = struct (...
        ...
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),100,0);
        testdefs{end+1} = struct (...
        ...
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),100,7);
        testdefs{end+1} = struct (...
        ...
        f = @(s,si)align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_taxi(s,si),100,0),1);
        testdefs{end+1} = struct (...
        ...
        f = @(s,si)align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_taxi(s,si),100,7),1);
        testdefs{end+1} = struct (...
        ...
        f = @(s,si)align_onsUtil_smooth(align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_taxi(s,si),100,0),1));
        testdefs{end+1} = struct (...
    ...
    if TESTDEFS_AGRESSION
        ...
        f_taxiTol1 = @(s,si,drop)align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_taxi(s,si),100,drop),1);
        ...
        f_taxiTol10 = @(s,si,drop)align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_taxi(s,si),100,drop),10);
        ...
        f_rectTol1 = @(s,si,drop)align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_rectL2(s,si),100,drop),1);
        ...
        f_rectTol10 = @(s,si,drop)align_onsUtil_leadingEdge(block_normalise(align_onsUtil_specDiff_rectL2(s,si),100,drop),10);
    ...
    if TESTDEFS_NORMLEN
        % width 10
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),10,0);
        testdefs{end+1} = struct (...
            "name"     , "N10", ...
            "testFunc" , f, ...
            "spectInfo", si_std ...
        ...
        % width 50
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),50,0);
        testdefs{end+1} = struct (...
            "name"     , "N50", ...
            "testFunc" , f, ...
            "spectInfo", si_std ...
        ...
        % width 300
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),300,0);
        testdefs{end+1} = struct (...
            "name"     , "N300", ...
            "testFunc" , f, ...
            "spectInfo", si_std ...
        ...
        % width 1000
        f = @(s,si)block_normalise(align_onsUtil_specDiff_taxi(s,si),1000,0);
        testdefs{end+1} = struct (...
            "name"     , "N1000", ...
            "testFunc" , f, ...
            "spectInfo", si_std ...
