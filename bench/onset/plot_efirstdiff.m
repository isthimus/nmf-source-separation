...
% functions to plot
test_funcs = { ...
    @(a, si) align_onsUtil_energyFirstDiff(a, si, 10, 500) ...
    @(a, si) align_onsUtil_energyFirstDiff(a, si, 10, 300) ...
    @(a, si) align_onsUtil_energyFirstDiff(a, si, 10, 100) ...
    @(a, si) align_onsUtil_energyFirstDiff(a, si, 30) ...
    @(a, si) align_onsUtil_energyFirstDiff(a, si, 40) ...
};
