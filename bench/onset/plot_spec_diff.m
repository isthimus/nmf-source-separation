...
% functions to plot
test_funcs = { ...
%    @aln_onsUtil_specDiff_taxi
%    @aln_onsUtil_specDiff_rectL2, ...
%    @(s,si)block_normalise(aln_onsUtil_specDiff_taxi(s,si),100,-99)
    @(s,si)block_normalise(aln_onsUtil_specDiff_taxi(s,si),100,0) % best 1D atm
    @(s,si)aln_onsUtil_leadingEdge(block_normalise(aln_onsUtil_specDiff_taxi(s,si),100,0))
%    @(s,si)block_normalise(aln_onsUtil_specDiff_taxi(s,si),100,10) 
%   @(s,si)block_normalise(aln_onsUtil_specDiff_rectL2(s,si),100,0)
%    @(s,si)block_normalise(aln_onsUtil_specDiff_rectL2(s,si),100,-3)
%    @(s, si)block_normalise(aln_onsUtil_specDiff_rectL2(s,si),100), ...
%   @(s,si)aln_onsUtil_bandSplit(s,si,@aln_onsUtil_specDiff_taxi) 
%    @(s,si)aln_onsUtil_bandSplit(s,si,@aln_onsUtil_specDiff_rectL2)
%   @(s,si)row_normalise(aln_onsUtil_bandSplit(s,si,@aln_onsUtil_specDiff_taxi),100) ...
%    @(s,si)row_normalise(aln_onsUtil_bandSplit(s,si,@aln_onsUtil_specDiff_rectL2), 100), ...
};
