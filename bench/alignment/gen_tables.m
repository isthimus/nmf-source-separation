function [testvectors, testdefs] = gen_tables(switches);
    ...
    if TESTDEFS_VANILLA
        ...
        testdefs{end+1} = struct (...
            "name"     , "vanillaUseVel", ...
            "testFunc" , @(n,a,s,si)aln_dtw(n,a,si,false), ...
            "spectInfo", si_std ...
        );
        ...
        testdefs{end+1} = struct (...
            "name"     , "vanillaNoVel", ...
            "testFunc" , @(n,a,s,si)aln_dtw(n,a,si,true), ...
            "spectInfo", si_std ...
        );
    end
    ...
    if TESTDEFS_ONSET_VEL
        ...
        for ratio_i = 1:length(chroma_ratios)
            ...
            testdefs{end+1} = struct (...
                "name"     , name, ...
                "testFunc" , @(n,a,s,si)aln_dtw_onset(n,a,s,si,onsFunc,ratio,true), ...
                "spectInfo", si_std ...
            );
    ...
    if TESTDEFS_ONSET_NOVEL
        ...
        for ratio_i = 1:length(chroma_ratios)
            ...
            testdefs{end+1} = struct (...
                "name"     , name, ...
                "testFunc" , @(n,a,s,si)aln_dtw_onset(n,a,s,si,onsFunc,ratio,false), ...
                "spectInfo", si_std ...
            );
