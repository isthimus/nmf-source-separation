function [testvectors, testdefs] = gen_tables(switches);
    ...
    if TESTDEFS_ONSET_VEL
        ...
        % s and si are the spect and spectinfo for align_onsUtil_specDiff_taxi
        % tol and drop are tolerance and dropout thresh for the normalisation
        onset_taxi = @(s,si,tol,drop) ...
            align_onsUtil_smooth( ...
                align_onsUtil_leadingEdge( ...
                    block_normalise( ...
                        align_onsUtil_specDiff_taxi(s,si), ...
                        100, ...
                        drop ...
                    ), ...
                    tol ...
        ...
        % partial function representing a block normalised spectral difference with 
        % leading edge detection and smoothing
        % s and si are the spect and spectinfo for align_onsUtil_specDiff_rectL2
        % tol and drop are tolerance and dropout thresh for the normalisation
        onset_rect = @(s,si,tol,drop) ...
            align_onsUtil_smooth( ...
                align_onsUtil_leadingEdge( ...
                    block_normalise( ...
                        align_onsUtil_specDiff_rectL2(s,si), ...
                        100, ...
                        drop ...
                    ), ...
                    tol ...
