...
% NSS_NMF_IS - perform NMF using update rules based on the Itakura-Seito divergence
%
%   arguments:
...
%       pair of update rules, checking the Itakura-Seito  (IS) divergence between W * H and V at every step.
%       When the IS divergence is small enough (see args above), W and H are returned as W_out, H_out. note
