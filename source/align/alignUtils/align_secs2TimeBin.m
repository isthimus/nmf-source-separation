function timeBins = aln_secs2TimeBin (t, spectInfo, use_audio_len)
    ...
    if use_audio_len
        % use audio length
    	timeBins = aln_samps2TimeBin(samps, spectInfo);
    else
        % don't use audio length
    	timeBins = aln_samps2TimeBin(samps, spectInfo, false);
    end
